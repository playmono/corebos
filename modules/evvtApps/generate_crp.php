    ...
    $sql1 = "SELECT *
		FROM vtiger_pcdetails
			LEFT JOIN vtiger_crmentity ON vtiger_crmentity.crmid=vtiger_pcdetails.pcdetailsid
                        ...
                        WHERE deleted=0 AND pcdetailsstatus='SHIPPED'
    ...
    $sql = "SELECT *
		FROM vtiger_pcdetails
			LEFT JOIN vtiger_crmentity ON vtiger_crmentity.crmid=vtiger_pcdetails.pcdetailsid
                        ...
                        LEFT JOIN vtiger_project ON vtiger_project.projectid=vtiger_pcdetails.project
                        WHERE deleted=0 AND pcdetailsstatus='SHIPPED' AND pcdetailsstatus != 'ANNULLATA DA CAT' AND pcdetailsstatus != 'ANNULLATO ORDINE'
			AND project=$inoutmaster
...
WHERE projectid =$inoutmaster";
   ...
   // $nr_doc=crp_series(); 
    ...
    $focus->column_fields['doctype']='OUTGOING DDT CRP';
...
//                     WHERE tipo_documento='OUTGOING DDT CRP' AND brand='TPV'  ";
//        
...
//{
//$settingquery="SELECT * FROM vtiger_setting 
//                     WHERE tipo_documento='OUTGOING DDT CRP'   ";
//        
//      $setting=$adb->query($settingquery);
...
$date=$adb->query_result($result1,0,'startdate');
   $adb->query("UPDATE vtiger_pcdetails set ddtnumber='".$nr_doc."',dateshipped='".$date."' WHERE project=".$inoutmaster);
