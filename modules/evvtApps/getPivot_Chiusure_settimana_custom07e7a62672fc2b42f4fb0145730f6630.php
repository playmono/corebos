<?php
    ...
    $tit="(Giorni di chiusura,CIN IW,CIN OOW,CIN Dealer,HR OOW,HR IW,Tek HR-PUR,PUR IW,PUR old,PUR OOW,DROP OOW,DROP IW,CRP per Numero *)";
		
                 include_once("modules/Reports/Reports.php");
include("modules/Reports/ReportRun.php");
$fp = fopen('Chiusure_settimana_custom07e7a62672fc2b42f4fb0145730f6630.csv', 'a');
global $adb;
    $type="";
      $nu="a";
$reportid="176";
