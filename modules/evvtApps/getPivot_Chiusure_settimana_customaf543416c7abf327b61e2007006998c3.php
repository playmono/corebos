...
$fp = fopen('Chiusure_settimana_customaf543416c7abf327b61e2007006998c3.csv', 'a');
global $adb;
    $type="";
      $nu="a";
$reportid="176";
...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
   ...
   $query=$quer[0]."   and vtiger_project.actualenddate >= (CURDATE( )- INTERVAL weekday( CURDATE( )) DAY ) and vtiger_project.actualenddate <= (CURDATE( ) + interval( 6 - weekday( CURDATE( ) )) DAY)   ";
$i1=0;
