...
$j=0;
	...
	for($i1=1;$i1<=$num_rows1;$i1++)
	{
       ...
       $md1=$adb->query_result($tab,0,"name");
        ...
        $query=$adb->query($qr." and vtiger_project.substatusproj NOT LIKE '%losed%' and vtiger_project.substatusproj NOT LIKE '%open%' ".$co." ".$lim);
        //echo str_replace("inner join vt_tmp_u26723 vt_tmp_u26723 on vt_tmp_u26723.id = vtiger_crmentity.smownerid"," ",$qr);  
