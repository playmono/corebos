...
global $current_user;
 $focus = new Messages();
   $focus->column_fields["name"] = $mv->messagesmessage;
  // if($mv->mestesso == '1'){  $focus->column_fields["assigned_user_id"] = $current_user->id;}
//   else 
$focus->column_fields["assigned_user_id"] = $current_user->id;
   $focus->column_fields["msgdescription"] = $mv->messagesmessage;
   $focus->column_fields["project"] =$mv->projectid;
  // $focus->column_fields["messagecategory"] =$mv->commentcategory;
   $focus->save("Messages");

}
else{
$fp = fopen('Overdue_CAT_custom32382ab9d528b04b258572eae7c32617.csv', 'a');
