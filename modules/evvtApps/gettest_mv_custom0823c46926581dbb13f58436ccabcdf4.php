...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
 ...
 $group=array();
  $k=0;
  $fld=explode(",","pname_template,progetto,projectname,projectstatus,substatusproj,projectid,projecttaskid,pt_substatus,status_pt,projecttaskname,timecontrolid,substatus,case_tc,title,status_timecontrol,date_start,time_start,date_end,time_end,deleted");
