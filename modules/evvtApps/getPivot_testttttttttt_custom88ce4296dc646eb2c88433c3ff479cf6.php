...
$fp = fopen('testttttttttt_custom88ce4296dc646eb2c88433c3ff479cf6.csv', 'a');
global $adb;
    $type="";
      $nu="a";
$reportid="";
...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
   ...
   $query=$quer[0]."  ";
$i1=0;
 $fld=explode(",","CAT,SOGLIE,soglieid,TengagementclienteHR,TpartrequestHR,TsentbyTekHR,TconfirmreceivHR,TrepairingHR,TripsenzapartiHR,TcloseHR,TclosewithoutpartHR,ada0a2gg1,ada03a5gg1,ada06a9gg1,ada10a15gg1,ada16a20gg1,aover21gg1,ytd0");
      $fldaggreg=explode(",","CAT,SOGLIE,soglieid,TengagementclienteHR,TpartrequestHR,TsentbyTekHR,TconfirmreceivHR,TrepairingHR,TripsenzapartiHR,TcloseHR,TclosewithoutpartHR,da 0 a 2 gg#count#soglieid,da 03 a 5 gg#count#soglieid,da 06 a 9 gg#count#soglieid,da 10 a 15 gg#count#soglieid,da 16 a 20 gg#count#soglieid,over 21 gg#count#soglieid,#count#soglieid");
                                  $fldn=explode(",","CAT,SOGLIE,soglieid,TengagementclienteHR,TpartrequestHR,TsentbyTekHR,TconfirmreceivHR,TrepairingHR,TripsenzapartiHR,TcloseHR,TclosewithoutpartHR,da 0 a 2 gg Numero soglieid,da 03 a 5 gg Numero soglieid,da 06 a 9 gg Numero soglieid,da 10 a 15 gg Numero soglieid,da 16 a 20 gg Numero soglieid,over 21 gg Numero soglieid,Year to date Numero soglieid");
                                 ...
                                 $typef=explode(","," ,field,field,field,field,field,field,field,field,field,field,field,fieldaggr,fieldaggr,fieldaggr,fieldaggr,fieldaggr,fieldaggr,ytd");
...
$dt=Array();
       ...
       //$mainfld1=explode(",","soglieid"); 
       $fagg1=explode(",","Numero soglieid");
           if(""=="1"){
