...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
 ...
 $group=array();
  $k=0;
  $fld=explode(",","projectid,projecttaskid,projectname,projecttaskname,timecontrolid,status_timecontrol,substatus,deleted,date_start,time_start,progetto,case_tc");
...
$group2=implode(",",$group);
        ...
        $query=$adb->query($qr." and status_timecontrol like "Rendicontata" ".$co." ".$lim);
