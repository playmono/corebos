...
global $adb;
$fp = fopen('CIN_SCORE_custom560e3ee2d5e978dd3a6001bec0741899.csv', 'a');
...
echo isPermitted("Accounts","index",$adb->query_result($query,$i1,"primid")).' '.$adb->query_result($query,$i1,"primid").' '.$adb->query_result($query,$i1,"CAT").'<br>';   
   if (isPermitted("Accounts","index",$adb->query_result($query,$i1,"primid"))=='yes' && isPermitted("Accounts","index",$adb->query_result($query,$i1,"primid"))=='yes'){
