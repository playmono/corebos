<?php
    ...
    $tit="(WEEK,Sorgente per Numero HelpDesk_ID)";
...
$dt=Array();
       ...
       $rspots1=$adb->query("SELECT  count(vtiger_crmentity.crmid)  as vtigercrmentitycrmid  FROM $query  and  REPLACE(CONCAT(vtiger_troubletickets.fiscalwint,' ',vtiger_troubletickets.sorgentett),\"'\",\"\")='$ptc' and vtiger_troubletickets.status=\"$cat[$m]\" ");
