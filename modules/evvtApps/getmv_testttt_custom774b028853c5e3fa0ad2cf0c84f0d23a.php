...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
 ...
 $group=array();
  $k=0;
  $fld=explode(",","projectid,projecttaskid,timecontrolid,status_timecontrol,projectname,deleted,date_start,time_start,projecttaskname,progetto,substatus,case_tc");
