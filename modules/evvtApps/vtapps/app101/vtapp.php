<?php
    ...
    class Cube_Giorni_CAT_custom6c80f1d7b1520069bc221fbff49dd5eb extends vtApp {
...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
 ...
 $group=array();
  $k=0;
  $fld=explode(",","Project_LBLGROUPBUYER,Project_Raggruppamento_Giorni,Project_ID,Project_Progetto_collegato,Project_Project_Name,Project_Project_No,Project_ID_progetto,Project_Substatus,Project_RMA,Project_Assigned_To,Project_Macro_status,Project_Account,Project_Data_di_Acquisto_del_Prodotto,Project_Start_Date,Project_Serial_Number,Project_Modified_Time,Project_Model_Number,Project_Id_product,Project_Brand,Project_Status,Project_Ragg._Giorni_WAIT");
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $fld=explode(",","Project_LBLGROUPBUYER,Project_Raggruppamento_Giorni,Project_ID,Project_Progetto_collegato,Project_Project_Name,Project_Project_No,Project_ID_progetto,Project_Substatus,Project_RMA,Project_Assigned_To,Project_Macro_status,Project_Account,Project_Data_di_Acquisto_del_Prodotto,Project_Start_Date,Project_Serial_Number,Project_Modified_Time,Project_Model_Number,Project_Id_product,Project_Brand,Project_Status,Project_Ragg._Giorni_WAIT,vis");
                                  $fldn=explode(",","CAT TPV,Giorni,N. chiamate,Project_Progetto_collegato,Project_Project_Name,Project_Project_No,Project_ID_progetto,Project_Substatus,Project_RMA,Project_Assigned_To,Project_Macro_status,Project_Account,Project_Data_di_Acquisto_del_Prodotto,Project_Start_Date,Project_Serial_Number,Project_Modified_Time,Project_Model_Number,Project_Id_product,Project_Brand,Project_Status,Project_Ragg._Giorni_WAIT,Visualizza");
                                  $checkf=explode(",","1,1,1,,,,,,,,,,,,,,,,,,,1");
                                  $grp=explode(",",",,,,,,,,,,,,,,,,,,,,,");
                                  $aggr=explode(",",",,count,,,,,,,,,,,,,,,,,,,");
                                 $suba=explode(",",",,count,,,,,,,,,,,,,,,,,,,");
                                        $wdth=explode(",","200,200,120,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,150");
                                     $f=Array();
                                     $s=Array();
                                     $a=Array();
                                    $g=Array();
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUICube_Giorni_CAT_custom6c80f1d7b1520069bc221fbff49dd5eb.tpl");
        }
