<?php
    ...
    class Overdue_CAT_custom42243c0272b6b7bb0783c86e44c3b2d8 extends vtApp {
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $fldn=explode(",","Chiamata,Cat,RMA,Data di inizio,Substatus,Stato parte,Overdue,Messaggio,Visualizza");
                                          $fldnex=explode(","," ,Chiamata,Cat,RMA,Data di inizio,Substatus,Stato parte,Overdue,Messaggio,Visualizza");
                                        $colex=explode(","," ,Chiamata,Cat,RMA,Data di inizio,Substatus,Stato parte,Overdue,Messaggio ,Visualizza");
                                 ...
                                 $suba=explode(",","count,,,,,,,,");
                                        ...
                                        $wdth=explode(",","120,200,120,120,200,120,80,200,150");
                                     $f=Array();
                                     $s=Array();
                                     $a=Array();
                                    $g=Array();
 ...
 $l=0;
 $m=0;
 $fp = fopen('Overdue_CAT_custom42243c0272b6b7bb0783c86e44c3b2d8.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvOverdue_CAT_custom42243c0272b6b7bb0783c86e44c3b2d8'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIOverdue_CAT_custom42243c0272b6b7bb0783c86e44c3b2d8.tpl");
        }
