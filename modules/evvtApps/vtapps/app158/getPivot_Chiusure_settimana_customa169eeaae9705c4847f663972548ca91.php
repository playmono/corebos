<?php
    ...
    $tit="(Giorni di chiusura,CIN IW,CIN OOW,CIN Dealer,HR OOW,HR IW,PUR,PUR OOW,DROP IW,DROP OOW,CRP per Numero *)";
		
                 include_once("modules/Reports/Reports.php");
include("modules/Reports/ReportRun.php");
$fp = fopen('Chiusure_settimana_customa169eeaae9705c4847f663972548ca91.csv', 'a');
global $adb;
    $type="";
      $nu="a";
$reportid="176";
