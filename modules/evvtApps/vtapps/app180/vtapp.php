<?php
    ...
    class On_Going_SONY_custom766116e4a94753822e08d0f5b8f37534 extends vtApp {
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $fld=explode(",","Project_Project_Name,Project_RMA,Project_Substatus,Project_LBLGROUPBUYER,Project_Account,Project_Start_Date,Project_Serial_Number,Project_Model_Number,vis");
                                  $fldn=explode(",","Nome Progetto,RMA,Substatus,Committente,Azienda/Cliente,Data d'inizio,Serial Number,Model Number,Visualizza");
                                          $fldnex=explode(","," ,Nome Progetto,RMA,Substatus,Committente,Azienda/Cliente,Data d'inizio,Serial Number,Model Number,Visualizza");
                                        $colex=explode(","," ,Nome Progetto,RMA,Substatus,Committente,Azienda/Cliente,Data d'inizio,Serial Number,Model Number ,Visualizza");
 ...
 $l=0;
 $m=0;
 $fp = fopen('On_Going_SONY_custom766116e4a94753822e08d0f5b8f37534.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvOn_Going_SONY_custom766116e4a94753822e08d0f5b8f37534'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIOn_Going_SONY_custom766116e4a94753822e08d0f5b8f37534.tpl");
        }
