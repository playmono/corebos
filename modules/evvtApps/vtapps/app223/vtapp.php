<?php
    ...
    class MRK_Chiamate_Annullate_customdebc81d167ffdc990f065f04c41a3176 extends vtApp {
...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
 ...
 $group=array();
  $k=0;
  $fld=explode(",","Project_Project_Name,Project_Substatus,Project_LBLGROUPBUYER,Project_Account,Project_Tipo_Incident,Project_Tipo_Incident_esteso,Project_ID_mail_Merkur");
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $fld=explode(",","Project_Project_Name,Project_Substatus,Project_LBLGROUPBUYER,Project_Account,Project_Tipo_Incident,Project_Tipo_Incident_esteso,Project_ID_mail_Merkur,vis");
                                  $fldn=explode(",","Nome Progetto,Substatus,Committente,Azienda/Cliente,Tipo Incident,Tipo Incident esteso,ID mail Merkur,Visualizza");
                                          $fldnex=explode(","," ,Nome Progetto,Substatus,Committente,Azienda/Cliente,Tipo Incident,Tipo Incident esteso,ID mail Merkur,Visualizza");
                                        $colex=explode(","," ,Nome Progetto,Substatus,Committente,Azienda/Cliente,Tipo Incident,Tipo Incident esteso,ID mail Merkur ,Visualizza");
                                 ...
                                 $suba=explode(",",",,,,,,,");
                                        ...
                                        $wdth=explode(",","200,200,200,200,200,200,200,150");
                                     $f=Array();
                                     $s=Array();
                                     $a=Array();
                                    $g=Array();
 ...
 $l=0;
 $m=0;
 $fp = fopen('MRK_Chiamate_Annullate_customdebc81d167ffdc990f065f04c41a3176.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvMRK_Chiamate_Annullate_customdebc81d167ffdc990f065f04c41a3176'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIMRK_Chiamate_Annullate_customdebc81d167ffdc990f065f04c41a3176.tpl");
        }
