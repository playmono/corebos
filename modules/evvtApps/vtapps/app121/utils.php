...
if(empty($inoutmaster)) $inoutmaster=str_replace(";",",",$_REQUEST["recordvalpdf"]);
        ...
        $sql1 = "SELECT vtiger_accountbillads.bill_city, vtiger_accountbillads.bill_state, vtiger_accountbillads.bill_country
		FROM vtiger_pcdetails
			LEFT JOIN vtiger_crmentity ON vtiger_crmentity.crmid=vtiger_pcdetails.pcdetailsid
                     ...
                     LEFT JOIN vtiger_accountbillads ON vtiger_adocmaster.adoc_account=vtiger_accountbillads.accountaddressid
	...
	$return .= '<tr><td colspan ="5"><table border="1" style="border-collapse:collapse;width:1400px;"><tr><td width="50%" height="100" style="vertical-align:top;padding-left:10px;border-left:black;border-bottom:black;"><font style="font-size:12px;font-family:Trebuchet MS;">LUOGO DI DESTINAZIONE<br/><br/>'.$acc_name.'<br/>'.$cityname.'<br/> '.$countyname.'<br/>'.$countriesname.'</font></td><td  width="50%" style="vertical-align:top;padding-left:10px;border-right:black;border-bottom:black;" ><font style="font-size:12px;font-family:Trebuchet MS;">DESTINATARIO: Residenza o domicilio<br/><br/>'.$acc_name.'<br/>'.$cityname.'<br/> '.$countyname.'<br/>'.$countriesname.'</font></td></tr></table></td></tr>';
	$return .= '<tr><td colspan ="5"><table border="1" style="border-collapse:collapse;width:1400px;"><tr><td ><table border="0" ><tr><td style="vertical-align:top;padding-left:10px;" width="40%"><font style="font-size:12px;font-family:Trebuchet MS;"> N. ORDINE</font></td>
            ...
            <td style="vertical-align:top;padding-left:10px;"  width="20%"><font style="font-size:12px;font-family:Trebuchet MS;">DATA ORDINE</font></td>
            <td style="vertical-align:top;padding-left:10px;" width="50%"><font style="font-size:12px;font-family:Trebuchet MS;">Vs. P.I.V.A. o C.F.</font></td></tr>';
	$return .= '<tr>
            ...
            <td style="vertical-align:top;padding-left:10px;" width="20%"><font style="font-size:12px;font-family:Trebuchet MS;">PORTO FRANCO</font>  <input type="checkbox"><br/><font style="font-size:12px;font-family:Trebuchet MS;">PORTO ASSEGNATO  <input type="checkbox"></font></td>
            ...
            <input type="checkbox"><font style="font-size:12px;font-family:Trebuchet MS;">MITTENTE</font>   <input type="checkbox"><font style="font-size:12px;font-family:Trebuchet MS;">DESTINATARIO</font>  <input type="checkbox"> <font style="font-size:12px;font-family:Trebuchet MS;">VETTORE </font></td></tr>
