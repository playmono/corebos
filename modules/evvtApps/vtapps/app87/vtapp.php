<?php
    ...
    class Chiamate_Laboratorio_CRP-PUR_custom538ecf0692dfe0e268a8a9f5217b74de extends vtApp {
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $aggr=explode(",",",,count,,,,,,,,,,,,,,,,,");
                                 $suba=explode(",",",,count,,,,,,,,,,,,,,,,,");
                                        $wdth=explode(",","200,160,160,200,140,80,200,200,200,200,200,200,80,100,200,100,200,200,80,150");
                                     $f=Array();
                                     $s=Array();
                                     $a=Array();
                                    $g=Array();
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIChiamate_Laboratorio_CRP-PUR_custom538ecf0692dfe0e268a8a9f5217b74de.tpl");
        }
