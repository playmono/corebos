<?php
    ...
    class MRK_Chiamate_chiuse_custom30a59861887966924c468c241b476371 extends vtApp {
...
global $adb,$current_language,$current_user;
 ...
 $l=0;
 $m=0;
 $fp = fopen('MRK_Chiamate_chiuse_custom30a59861887966924c468c241b476371.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvMRK_Chiamate_chiuse_custom30a59861887966924c468c241b476371'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIMRK_Chiamate_chiuse_custom30a59861887966924c468c241b476371.tpl");
        }
