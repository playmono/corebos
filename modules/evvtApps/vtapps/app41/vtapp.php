<?php
    ...
    class Pivot_TT_substatus_custom2ecc550f4647d1a0260526d12fb8b573 extends vtApp {
...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
 ...
 $group=array();
  $k=0;
  $fld=explode(",","HelpDesk_ID,HelpDesk_Title,HelpDesk_Related_To,HelpDesk_Assigned_To,HelpDesk_Status,HelpDesk_Created_Time,HelpDesk_Update_History,HelpDesk_Modified_Time,HelpDesk_Ticket_No,HelpDesk_Categoria_segnalazione,HelpDesk_Project,HelpDesk_Description,HelpDesk_Solution");
...
if(""!="1"){
                                  $fld=explode(",","vtiger_troubletickets.reportingcategory,$cat2, $form Totale");
                                  $fldn=explode(",","Categoria,Status $cat,$form Totale");
                                  $checkf=explode(",",",,,,,,,,,1,,,,1");
                                  $grp=explode(",",",,");
                                  $aggr=explode(",",",,,");
                                 $suba=explode(",",",,");
          ...
          $fld=explode(",","vtiger_troubletickets.reportingcategory,$cat2,ytd,$form Totale");
                                  $fldn=explode(",","Categoria,Status $cat,Year to date, $form Totale");
                                  $checkf=explode(",",",,,,,,,,,1,,,,1");
                                  $grp=explode(",",",,");
                                  $aggr=explode(",",",,,");
                                 $suba=explode(",",",,");
                                        $wdth=explode(",","200,200, $ww,80");                               }
                                     $f=Array();
                                     $s=Array();
                                     $a=Array();
                                    $g=Array();
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUITT_substatus_custom2ecc550f4647d1a0260526d12fb8b573.tpl");
        }
