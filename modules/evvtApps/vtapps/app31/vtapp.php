<?php
    ...
    class Pending_custom679889e066a8cc0b543bd44741f60c22 extends vtApp {
	...
	var $eheight = 0;
        ...
        return $query[0]." and vtiger_project.substatusproj NOT LIKE '%losed%' and vtiger_project.substatusproj NOT LIKE '%open%' ".$co." limit ".$query[1];
}
...
$j=0;
	...
	for($i1=1;$i1<=$num_rows1;$i1++)
	{
       ...
       $md1=$adb->query_result($tab,0,"name");
        ...
        $query=$qr." and vtiger_project.substatusproj NOT LIKE '%losed%' and vtiger_project.substatusproj NOT LIKE '%open%' ".$co." ".$lim;
        return $query;
}
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIPending_custom679889e066a8cc0b543bd44741f60c22.tpl");
        }
