<?php
    ...
    $tit="(Committente / CAT per Somma Totale)";
		
                 include_once("modules/Reports/Reports.php");
include("modules/Reports/ReportRun.php");
$fp = fopen('tempi_custom2ffc40a7bf48cddc201f0ae1e81c36e0.csv', 'a');
global $adb;
    $type="";
      $nu="a";
$reportid="153";
...
$dt=Array();
       ...
       $rspots1=$adb->query("SELECT  count(vtiger_crmentity.crmid)  as vtigercrmentitycrmid,sum(vtiger_projectmilestone.tempoattesaparti)  as vtigerprojectmilestonetempoattesaparti,sum(vtiger_projectmilestone.tempoengagement)  as vtigerprojectmilestonetempoengagement,sum(vtiger_projectmilestone.tricezprod)  as vtigerprojectmilestonetricezprod,sum(vtiger_projectmilestone.tpartreq)  as vtigerprojectmilestonetpartreq,sum(vtiger_projectmilestone.sentbytek)  as vtigerprojectmilestonesentbytek,sum(vtiger_projectmilestone.tconfreceived)  as vtigerprojectmilestonetconfreceived,sum(vtiger_projectmilestone.trepairing)  as vtigerprojectmilestonetrepairing,sum(vtiger_projectmilestone.tready)  as vtigerprojectmilestonetready,sum(vtiger_projectmilestone.tempototale)  as vtigerprojectmilestonetempototale  FROM $query  and  REPLACE(CONCAT(vtiger_project.linktobuyer),\"'\",\"\")='$ptc' and =\"$cat[$m]\" ");
       ...
       $rspots22=$adb->query("SELECT  count(vtiger_crmentity.crmid)  as vtigercrmentitycrmid,sum(vtiger_projectmilestone.tempoattesaparti)  as vtigerprojectmilestonetempoattesaparti,sum(vtiger_projectmilestone.tempoengagement)  as vtigerprojectmilestonetempoengagement,sum(vtiger_projectmilestone.tricezprod)  as vtigerprojectmilestonetricezprod,sum(vtiger_projectmilestone.tpartreq)  as vtigerprojectmilestonetpartreq,sum(vtiger_projectmilestone.sentbytek)  as vtigerprojectmilestonesentbytek,sum(vtiger_projectmilestone.tconfreceived)  as vtigerprojectmilestonetconfreceived,sum(vtiger_projectmilestone.trepairing)  as vtigerprojectmilestonetrepairing,sum(vtiger_projectmilestone.tready)  as vtigerprojectmilestonetready,sum(vtiger_projectmilestone.tempototale)  as vtigerprojectmilestonetempototale  FROM $query  and  REPLACE(CONCAT(vtiger_project.linktobuyer),\"'\",\"\")='$ptc' and DATE_FORMAT(,'%Y-%m-%d')>'$dttod2' and DATE_FORMAT(,'%Y-%m-%d')<='$dttod' and =\"$cat[$m]\"");
...
$ag2[$ii]+=number_format($adb->query_result($rspots1,0,"$mf"),2,",",".");
     ...
     if(""=="1"){
            $dttod=date("Y-m-d",strtotime("-1 years",strtotime(date("Y-m-d"))));
             $dttod2=date("Y-m-d",strtotime("-2 years",strtotime(date("Y-m-d"))));
       $rspots2=$adb->query("SELECT  count(vtiger_crmentity.crmid)  as vtigercrmentitycrmid,sum(vtiger_projectmilestone.tempoattesaparti)  as vtigerprojectmilestonetempoattesaparti,sum(vtiger_projectmilestone.tempoengagement)  as vtigerprojectmilestonetempoengagement,sum(vtiger_projectmilestone.tricezprod)  as vtigerprojectmilestonetricezprod,sum(vtiger_projectmilestone.tpartreq)  as vtigerprojectmilestonetpartreq,sum(vtiger_projectmilestone.sentbytek)  as vtigerprojectmilestonesentbytek,sum(vtiger_projectmilestone.tconfreceived)  as vtigerprojectmilestonetconfreceived,sum(vtiger_projectmilestone.trepairing)  as vtigerprojectmilestonetrepairing,sum(vtiger_projectmilestone.tready)  as vtigerprojectmilestonetready,sum(vtiger_projectmilestone.tempototale)  as vtigerprojectmilestonetempototale  FROM $query  and  REPLACE(CONCAT(vtiger_project.linktobuyer),\"'\",\"\")='$ptc' and DATE_FORMAT(,'%Y-%m-%d')>'$dttod2' and DATE_FORMAT(,'%Y-%m-%d')<='$dttod'");
