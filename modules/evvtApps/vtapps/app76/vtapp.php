<?php
 ...
 class Incoming extends vtApp {
	...
	var $eheight = 0;
        ...
        return $query[0]." and vtiger_project.substatusproj LIKE '%open%' ".$co." limit ".$query[1];
}
...
$j=0;
	...
	for($i1=1;$i1<=$num_rows1;$i1++)
	{
       ...
       $md1=$adb->query_result($tab,0,"name");
        ...
        $query=$qr." and vtiger_project.substatusproj LIKE '%open%' ".$co." ".$lim;
        return $query;
}
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $aggr=explode(",",",,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,");
                                 $suba=explode(",",",,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,,");
                                        $wdth=explode(",","170,200,60,90,90,100,130,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,150");
                                     $f=Array();
                                     $s=Array();
                                     $a=Array();
                                    $g=Array();
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIIncoming_customebdeab5488fcb1daf311027ad4ae5a1c.tpl");
        }
