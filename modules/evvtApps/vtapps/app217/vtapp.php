<?php
    ...
    class Chiamate_TPV_Open_custom25909cca2b44506d05b82d3a8049a4db extends vtApp {
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $fldn=explode(",","Project_Commessa_originaria,Commessa,RMA,Project_ID_progetto,Project_Customer_Type,Numero Progetto,Committente,Data d'inizio,Azienda/Cliente,Project_Created_Time, SPAR associato,Project_Giorni_apertura_NON_business,Stato Chiamata,Project_Days_on,Substatus,Project_Data_chiusura_in_HPSM,Project_Stato_della_lavorazione,Model Number,Serial Number,Project_Stato_parte_chiamata,Project_Dealer_name,Visualizza");
                                          $fldnex=explode(","," ,Project_Commessa_originaria,Commessa,RMA,Project_ID_progetto,Project_Customer_Type,Numero Progetto,Committente,Data d'inizio,Azienda/Cliente,Project_Created_Time, SPAR associato,Project_Giorni_apertura_NON_business,Stato Chiamata,Project_Days_on,Substatus,Project_Data_chiusura_in_HPSM,Project_Stato_della_lavorazione,Model Number,Serial Number,Project_Stato_parte_chiamata,Project_Dealer_name,Visualizza");
                                        $colex=explode(","," ,Commessa,RMA,Numero Progetto,Committente,Data d'inizio,Azienda/Cliente, SPAR associato,Stato Chiamata,Substatus,Model Number,Serial Number ,Visualizza");
                                 ...
                                 $suba=explode(",",",,,,,,count,,,,,,,,,,,,,,,");
                                        ...
                                        $wdth=explode(",","200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,150");
                                     $f=Array();
                                     $s=Array();
                                     $a=Array();
                                    $g=Array();
 ...
 $l=0;
 $m=0;
 $fp = fopen('Chiamate_TPV_Open_custom25909cca2b44506d05b82d3a8049a4db.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvChiamate_TPV_Open_custom25909cca2b44506d05b82d3a8049a4db'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIChiamate_TPV_Open_custom25909cca2b44506d05b82d3a8049a4db.tpl");
        }
