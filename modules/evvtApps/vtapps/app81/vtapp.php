<?php
    ...
    class Pivot_TT_pivot_errori_custom86582212ae0504e8393eac0938c89d64 extends vtApp {
...
if(""!="1"){
                                  $fld=explode(",","vtiger_troubletickets.fiscalwint_vtiger_troubletickets.opendatatext,$cat2, $form $form2 Totale");
                                  $fldn=explode(",","WEEK_GIORNO,Status $cat,$form1 $form12 Totale");
          ...
          $fld=explode(",","vtiger_troubletickets.fiscalwint_vtiger_troubletickets.opendatatext,$cat2,$ytd,$form $form2 Totale");
                                  $fldn=explode(",","WEEK_GIORNO,Status $cat,$ytd1, $form1 $form12 Totale");
                                  $checkf=explode(",",",,,,,,,,,,,,,,,,,,1,1,1");
                                  $grp=explode(",",",,");
                                  $aggr=explode(",",",,,");
                                 $suba=explode(",",",,");
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUITT_pivot_errori_custom86582212ae0504e8393eac0938c89d64.tpl");
        }
