<?php
    ...
    class Dayson_overdue_MV_custom421d325368b9b2b01b2551c605b00895 extends vtApp {
...
$fl=implode(",",$fl);
                $rq=explode("from","select $fl from mv_testadayson ");
...
global $adb,$current_language,$current_user;
 ...
 $l=0;
 $m=0;
 $fp = fopen('Dayson_overdue_MV_custom421d325368b9b2b01b2551c605b00895.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvDayson_overdue_MV_custom421d325368b9b2b01b2551c605b00895'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIDayson_overdue_MV_custom421d325368b9b2b01b2551c605b00895.tpl");
        }
