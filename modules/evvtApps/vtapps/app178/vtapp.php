<?php
    ...
    class In_Attesa_Conferma_Garanzia_customfd9edbd9a2099d364d388dff01de7dd5 extends vtApp {
...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
 ...
 $group=array();
  $k=0;
  $fld=explode(",","Project_Project_Name,Project_Substatus,Project_RMA,Project_LBLGROUPBUYER,Project_Account,Project_Start_Date,Project_Serial_Number,Project_Model_Number");
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $fld=explode(",","Project_Project_Name,Project_Substatus,Project_RMA,Project_LBLGROUPBUYER,Project_Account,Project_Start_Date,Project_Serial_Number,Project_Model_Number,vis");
                                  $fldn=explode(",","Nome Progetto,Substatus,RMA,Committente,Azienda/Cliente,Data d'inizio,Serial Number,Model Number,Visualizza");
                                          $fldnex=explode(","," ,Nome Progetto,Substatus,RMA,Committente,Azienda/Cliente,Data d'inizio,Serial Number,Model Number,Visualizza");
                                        $colex=explode(","," ,Nome Progetto,Substatus,RMA,Committente,Azienda/Cliente,Data d'inizio,Serial Number,Model Number ,Visualizza");
 ...
 $l=0;
 $m=0;
 $fp = fopen('In_Attesa_Conferma_Garanzia_customfd9edbd9a2099d364d388dff01de7dd5.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvIn_Attesa_Conferma_Garanzia_customfd9edbd9a2099d364d388dff01de7dd5'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIIn_Attesa_Conferma_Garanzia_customfd9edbd9a2099d364d388dff01de7dd5.tpl");
        }
