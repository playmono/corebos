<?php
    ...
    $tit="(CAT per Media Totale)";
		
                 include_once("modules/Reports/Reports.php");
include("modules/Reports/ReportRun.php");
$fp = fopen('Timeline_CIN_custom4b692d43ba856463b837220ddee3e7cc.csv', 'a');
global $adb;
    $type="";
      $nu="a";
$reportid="153";
...
$dt=Array();
       ...
       $rspots1=$adb->query("SELECT  avg(vtiger_project.linktoaccountscontacts)  as vtigerprojectlinktoaccountscontacts,avg(vtiger_projectmilestone.tempoengagement)  as vtigerprojectmilestonetempoengagement,avg(vtiger_projectmilestone.tricezprod)  as vtigerprojectmilestonetricezprod,avg(vtiger_projectmilestone.tpartreq)  as vtigerprojectmilestonetpartreq,avg(vtiger_projectmilestone.sentbytek)  as vtigerprojectmilestonesentbytek,avg(vtiger_projectmilestone.tempoattesaparti)  as vtigerprojectmilestonetempoattesaparti,avg(vtiger_projectmilestone.tconfreceived)  as vtigerprojectmilestonetconfreceived,avg(vtiger_projectmilestone.trepairing)  as vtigerprojectmilestonetrepairing,avg(vtiger_projectmilestone.tready)  as vtigerprojectmilestonetready,avg(vtiger_projectmilestone.tempototale)  as vtigerprojectmilestonetempototale  FROM $query  and  REPLACE(CONCAT(vtiger_project.linktobuyer),\"'\",\"\")='$ptc' and =\"$cat[$m]\" ");
       $mainfld1=explode(",","vtiger_project.linktoaccountscontacts,vtiger_projectmilestone.tempoengagement,vtiger_projectmilestone.tricezprod,vtiger_projectmilestone.tpartreq,vtiger_projectmilestone.sentbytek,vtiger_projectmilestone.tempoattesaparti,vtiger_projectmilestone.tconfreceived,vtiger_projectmilestone.trepairing,vtiger_projectmilestone.tready,vtiger_projectmilestone.tempototale"); 
       $fagg1=explode(",","Media Project_Account,Media engage,Media ricezione prod,Media part request,Media sent Tek,Media attesa,Media conf receiv,Media repairing,Media ready deliv,Media Totale");
           if(""=="1"){
            $dttod=date("Y-m-d",strtotime("-1 years",strtotime(date("Y-m-d"))));
             $dttod2=date("Y-m-d",strtotime("-2 years",strtotime(date("Y-m-d"))));
       $rspots22=$adb->query("SELECT  avg(vtiger_project.linktoaccountscontacts)  as vtigerprojectlinktoaccountscontacts,avg(vtiger_projectmilestone.tempoengagement)  as vtigerprojectmilestonetempoengagement,avg(vtiger_projectmilestone.tricezprod)  as vtigerprojectmilestonetricezprod,avg(vtiger_projectmilestone.tpartreq)  as vtigerprojectmilestonetpartreq,avg(vtiger_projectmilestone.sentbytek)  as vtigerprojectmilestonesentbytek,avg(vtiger_projectmilestone.tempoattesaparti)  as vtigerprojectmilestonetempoattesaparti,avg(vtiger_projectmilestone.tconfreceived)  as vtigerprojectmilestonetconfreceived,avg(vtiger_projectmilestone.trepairing)  as vtigerprojectmilestonetrepairing,avg(vtiger_projectmilestone.tready)  as vtigerprojectmilestonetready,avg(vtiger_projectmilestone.tempototale)  as vtigerprojectmilestonetempototale  FROM $query  and  REPLACE(CONCAT(vtiger_project.linktobuyer),\"'\",\"\")='$ptc' and DATE_FORMAT(,'%Y-%m-%d')>'$dttod2' and DATE_FORMAT(,'%Y-%m-%d')<='$dttod' and =\"$cat[$m]\"");
...
$ag2[$ii]+=number_format($adb->query_result($rspots1,0,"$mf"),2,",",".");
     ...
     if(""=="1"){
            $dttod=date("Y-m-d",strtotime("-1 years",strtotime(date("Y-m-d"))));
             $dttod2=date("Y-m-d",strtotime("-2 years",strtotime(date("Y-m-d"))));
       $rspots2=$adb->query("SELECT  avg(vtiger_project.linktoaccountscontacts)  as vtigerprojectlinktoaccountscontacts,avg(vtiger_projectmilestone.tempoengagement)  as vtigerprojectmilestonetempoengagement,avg(vtiger_projectmilestone.tricezprod)  as vtigerprojectmilestonetricezprod,avg(vtiger_projectmilestone.tpartreq)  as vtigerprojectmilestonetpartreq,avg(vtiger_projectmilestone.sentbytek)  as vtigerprojectmilestonesentbytek,avg(vtiger_projectmilestone.tempoattesaparti)  as vtigerprojectmilestonetempoattesaparti,avg(vtiger_projectmilestone.tconfreceived)  as vtigerprojectmilestonetconfreceived,avg(vtiger_projectmilestone.trepairing)  as vtigerprojectmilestonetrepairing,avg(vtiger_projectmilestone.tready)  as vtigerprojectmilestonetready,avg(vtiger_projectmilestone.tempototale)  as vtigerprojectmilestonetempototale  FROM $query  and  REPLACE(CONCAT(vtiger_project.linktobuyer),\"'\",\"\")='$ptc' and DATE_FORMAT(,'%Y-%m-%d')>'$dttod2' and DATE_FORMAT(,'%Y-%m-%d')<='$dttod'");
