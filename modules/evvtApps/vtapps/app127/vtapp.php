<?php
    ...
    class Pivot_Timeline_CIN_custom4b692d43ba856463b837220ddee3e7cc extends vtApp {
...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
 ...
 $group=array();
  $k=0;
  $fld=explode(",","Project_ID,Project_Progetto_collegato,Project_Project_Name,Project_Project_No,Project_Substatus,Project_RMA,Project_LBLGROUPBUYER,Project_ID_progetto,Project_Assigned_To,Project_Macro_status,Project_Account,ProjectMilestone_T._engagement_cliente,ProjectMilestone_T._ricezione_prodotto,ProjectMilestone_T._part_request,ProjectMilestone_T._sent_by_Tek,ProjectMilestone_T._attesa_parti,ProjectMilestone_T._confirm_receiv.,ProjectMilestone_T._repairing,ProjectMilestone_T._ready_to_deliver,ProjectMilestone_T._Totale");
...
if(""!="1"){
                                  ...
                                  $fldn=explode(",","CAT, $cat $form1 $form12 $tot");
                                  $fldnex=explode(","," ,CAT, $cat $form1 $form12 $tot");
...
$checkf=explode(",",",,,,,,1,,,,,,,,,,,,,,1");
          ...
          $fld=explode(",","vtiger_project.linktobuyer,$cat2 $ytd $form $form2 $tot");
                                  $fldn=explode(",","CAT, $cat $ytd1 $form1 $form12 $tot");
                                  $fldnex=explode(","," ,CAT, $cat $ytd1 $form1 $form12 $tot");
...
$fp = fopen('Timeline_CIN_custom4b692d43ba856463b837220ddee3e7cc.csv', 'w');
    fputcsv($fp, $fldnex,";");
    fclose($fp);
 $l=0;
 $m=0;
 echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvPivot_Timeline_CIN_custom4b692d43ba856463b837220ddee3e7cc'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUITimeline_CIN_custom4b692d43ba856463b837220ddee3e7cc.tpl");
        }
