<?php
    ...
    class KPI_for_CAT_custom66c3afa3d303b62a2eba782c25bb72af extends vtApp {
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $fld=explode(",","id,data,meseanno,commessa,committente,numerochiamate,check21,medialtp,checkltp,adjcheckltp,medialtr,checkltr,adjcheckltr,medialtrhr,checkltrhr,adjcheckltrhr");
                                  $fldn=explode(",","id,data,Mese-anno,commessa,committente,numero chiamate,check21,medialtp,checkltp,adjcheckltp,medialtr,checkltr,adjcheckltr,medialtrhr,checkltrhr,adjcheckltrhr");
                                          $fldnex=explode(","," ,id,data,Mese-anno,commessa,committente,numero chiamate,check21,medialtp,checkltp,adjcheckltp,medialtr,checkltr,adjcheckltr,medialtrhr,checkltrhr,adjcheckltrhr");
                                        $colex=explode(","," ,Mese-anno,commessa,committente,numero chiamate,check21,checkltp,adjcheckltr");
                                 ...
                                 $suba=explode(",",",,,,,count,,,,,,,,,,");
                                        ...
                                        $wdth=explode(",","200,200,120,80,100,60,60,60,60,60,60,60,60,,200,200");
                                     $f=Array();
                                     $s=Array();
                                     $a=Array();
                                    $g=Array();
 ...
 $l=0;
 $m=0;
 $fp = fopen('KPI_for_CAT_custom66c3afa3d303b62a2eba782c25bb72af.csv', 'w');
     fprintf($fp, chr(0xEF).chr(0xBB).chr(0xBF));
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvKPI_for_CAT_custom66c3afa3d303b62a2eba782c25bb72af'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIKPI_for_CAT_custom66c3afa3d303b62a2eba782c25bb72af.tpl");
        }
