...
<div {$class} >
    <b>{$fldlabel.displaylabel}</b> &nbsp;&nbsp;&nbsp;&nbsp;
       ...
       <img src="themes/softed/images/select.gif" tabindex="{$vt_tab}"
...
<img src="themes/softed/images/btnL3Calendar.gif" id="jscal_trigger_{$fldname}">
