    ...
    {/literal}
            ...
            <style scoped>
                ...
                <script>
                    ...
                    //alert('index.php?module=evvtApps&action=evvtAppsAjax&file=kendo_content_merkur&kaction=display&id='+id+'&module_selected='+document.getElementById('module_selected').value);
                        $.post('index.php?module=evvtApps&action=evvtAppsAjax&file=kendo_content_merkur&kaction=display&id='+id+'&index='+index+'&module_selected='+document.getElementById('module_selected'+index).value+'&module_related='+document.getElementById('module_related'+index).value,
                          ...
                          //alert('index.php?module=evvtApps&action=evvtAppsAjax&file=kendo_content_merkur&kaction=add_new&type=edit&&id='+id+'&module_selected='+document.getElementById('module_selected').value);
                          //$.post('index.php?module=evvtApps&action=evvtAppsAjax&file=kendo_content_merkur&kaction=add_new&type=edit&id='+id+'&module_selected='+document.getElementById('module_selected').value,
                          //{mod:''},
                          //function(data,status){
                    ...
                    //alert(str);
                        $.post('index.php?module=evvtApps&action=evvtAppsAjax&file=kendo_content_merkur&kaction=add_new&type=create&related_id='+related_id+'&id='+id+'&module_selected='+document.getElementById('module_selected'+index).value+'&index='+index,
                          {onsave_secondary:'{/literal}{$onsave_secondary}{literal}',
                           onsave_primary:'{/literal}{$onsave_primary}{literal}',
                           profile:{/literal}{$Profile}{literal},
                           appid:'{/literal}{$appid}{literal}'
