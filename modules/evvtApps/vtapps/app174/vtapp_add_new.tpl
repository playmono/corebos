...
function add_new(index,mod,mod_rel,id,rel_id,columns)
{
    ...
    }//alert('index.php?module=evvtApps&action=evvtAppsAjax&file=kendo_content_merkur&kaction=save&id={/literal}{$id}{literal}&related_id={/literal}{$related_id}{literal}&req='+req+'&val='+val+'&module_selected={/literal}{$MODULE}{literal}');
 $.post('index.php?module=evvtApps&action=evvtAppsAjax&file=kendo_content_merkur&kaction=save&id='+id+'&related_id='+rel_id+'&req='+req+'&val='+val+'&module_selected='+mod,
          {mod:''},
...
{ 
 ...
 //alert('index.php?module=evvtApps&action=evvtAppsAjax&file=kendo_content_merkur&kaction=display&module_selected='+mod_rel+'&id='+rel_id+'&module_related='+mod+'&index='+index);
 if(rel_id !='')
 {
    $.post('index.php?module=evvtApps&action=evvtAppsAjax&file=kendo_content_merkur&kaction=display&module_selected='+mod_rel+'&id='+rel_id+'&module_related='+mod+'&index='+index,
      ...
      $.post('index.php?module=evvtApps&action=evvtAppsAjax&file=kendo_content_merkur&kaction=display&module_selected='+mod+'&id='+id+'&module_related='+mod_rel+'&index='+index,
          {add_document:'{/literal}{$add_document}{literal}',
           edit_this:'{/literal}{$edit_this}{literal}',
           go_to_dtlview:'{/literal}{$go_to_dtlview}{literal}',
           profile:{/literal}{$Profile}{literal},
...
jQuery(document).ready(function () {
  ...
  async: {
        ...
        saveUrl: "index.php?module=evvtApps&action=evvtAppsAjax&file=kendo_content_merkur&kaction=upload",
        autoUpload: true
    }
