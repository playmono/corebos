<?php
    ...
    class Pivot_Giorni_CAT_custome1c283b371e5823b0d4cc243714ca9e3 extends vtApp {
...
if(""!="1"){
                                  ...
                                  $fldn=explode(",","CAT TPV,Giorni $cat $form1 $form12 $tot");
                                  $checkf=explode(",",",,,,,,1,,,,,,,,,,,,,,,1");
                                  $grp=explode(",",",,");
                                  $aggr=explode(",",",,,");
                                 $suba=explode(",",",,");
          ...
          $fld=explode(",","vtiger_project.linktobuyer,$cat2 $ytd $form $form2 $tot");
                                  $fldn=explode(",","CAT TPV,Giorni $cat $ytd1 $form1 $form12 $tot");
                                  $checkf=explode(",",",,,,,,1,,,,,,,,,,,,,,,1");
                                  $grp=explode(",",",,");
                                  $aggr=explode(",",",,,");
                                 $suba=explode(",",",,");
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIGiorni_CAT_custome1c283b371e5823b0d4cc243714ca9e3.tpl");
        }
