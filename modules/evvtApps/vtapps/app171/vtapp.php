<?php
    ...
    class HR_per_prediagnosi_custom2dd45d92d565ed9589bfe271d6b95458 extends vtApp {
...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
 ...
 $group=array();
  $k=0;
  $fld=explode(",","Project_RMA,Project_Project_Name,Project_LBLGROUPBUYER,Project_Start_Date,Project_Serial_Number,Project_Substatus,Project_Account,Project_Assigned_To,Project_ID_progetto");
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $fld=explode(",","Project_RMA,Project_Project_Name,Project_LBLGROUPBUYER,Project_Start_Date,Project_Serial_Number,Project_Substatus,Project_Account,Project_Assigned_To,Project_ID_progetto,vis");
                                  $fldn=explode(",","Project_RMA,Project_Project_Name,Project_LBLGROUPBUYER,Project_Start_Date,Project_Serial_Number,Project_Substatus,Project_Account,Project_Assigned_To,Project_ID_progetto,Visualizza");
                                          $fldnex=explode(","," ,Project_RMA,Project_Project_Name,Project_LBLGROUPBUYER,Project_Start_Date,Project_Serial_Number,Project_Substatus,Project_Account,Project_Assigned_To,Project_ID_progetto,Visualizza");
                                        $colex=explode(","," ,Project_RMA,Project_Project_Name,Project_LBLGROUPBUYER,Project_Start_Date,Project_Serial_Number,Project_Substatus,Project_Account,Project_Assigned_To,Project_ID_progetto ,Visualizza");
                                 ...
                                 $suba=explode(",",",,,,,,,,,");
                                        ...
                                        $wdth=explode(",","200,200,200,200,200,200,200,200,200,150");
                                     $f=Array();
                                     $s=Array();
                                     $a=Array();
                                    $g=Array();
 ...
 $l=0;
 $m=0;
 $fp = fopen('HR_per_prediagnosi_custom2dd45d92d565ed9589bfe271d6b95458.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvHR_per_prediagnosi_custom2dd45d92d565ed9589bfe271d6b95458'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIHR_per_prediagnosi_custom2dd45d92d565ed9589bfe271d6b95458.tpl");
        }
