 <?php
        class Form Merkur extends vtApp {
                ...
                public function getContent($lang) {
                        ...
                        $smarty->assign('onopen_primary','autoedit');
                        $smarty->assign('onopen_secondary','blank');
                        $smarty->assign('onsave_secondary','autoshut');
                        $smarty->assign('onsave_primary','leave');
                        $smarty->assign('add_document',true);
