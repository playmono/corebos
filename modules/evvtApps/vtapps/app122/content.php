<table cellpadding="1" cellspacing="1" style="border-collapse: collapse;width:1400px;">
	<tbody>
		<tr>
			<td>
				<p>
					<span style="font-size:12px;"><span style="font-family: 'Times New Roman';">Teknema</span></span></p>
				<p>
					<span style="font-size:12px;">Soluzioni, Tecnologie e Multimedialità</span></p>
			</td>
					...
					<tbody>
						<tr>
							<td style="text-align: center;" width="300">
								<span style="font-size:12px;"><strong style="text-align: center; font-size: small; ">DOCUMENTO DI TRASPORTO</strong><br style="text-align: center; font-size: small; " />
								<span style="text-align: center;">(D.d.t.) - D.P.R. 472 del 14-08-1996</span><br style="text-align: center; font-size: small; " />
								<br />
		...
		<tr>
			<td>
				<p>
					 </p>
				<p>
					<span style="font-size:12px;"><strong style="font-size: large; ">Teknema s.r.l.</strong></span></p>
			</td>
			<td>
				 </td>
		</tr>
		<tr>
			<td>
				...
				<p>
					 </p>
				<p>
					<span style="font-size:12px;"><em style="font-size: x-small; ">Sede Operativa:</em>&nbsp;Via Petrarca, 2 - 20058 Villasanta MB&nbsp;<br style="font-size: x-small; " />
					Tel. 039 23411 - Fax 039 2341401&nbsp;<br style="font-size: x-small; " />
					<em style="font-size: x-small; ">Sede Legale:</em>Corso Milano 23 - 20052 Monza MB</span></p>
			</td>
			<td style="text-align: right;">
				...
				<p>
					 </p>
				<p>
					<span style="font-size:12px;">Capitale sociale € 99.000<br style="font-size: x-small; " />
					Partita IVA - Codice Fiscale - Registro Imprese 02611890969<br style="font-size: x-small; " />
