...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $fld=explode(",","Project_Progetto_collegato,Project_RMA,Project_ID_progetto,Project_Project_No,Project_Start_Date,Project_LBLGROUPBUYER,Project_Substatus,Project_Stato_parte_chiamata,Project_Days_on,HelpDesk_Ticket_No,HelpDesk_Title,HelpDesk_Status,vis");
                                  $fldn=explode(",","Chiamata,RMA,ID chiamata,Numero chiamata,Data inizio chiamata,Committente,Substatus chiamata,Stato parte chiamata,Giorni nello stesso stato,Numero Ticket,Titolo Ticket,Stato Ticket,Visualizza");
                                          $fldnex=explode(","," ,Chiamata,RMA,ID chiamata,Numero chiamata,Data inizio chiamata,Committente,Substatus chiamata,Stato parte chiamata,Giorni nello stesso stato,Numero Ticket,Titolo Ticket,Stato Ticket,Visualizza");
