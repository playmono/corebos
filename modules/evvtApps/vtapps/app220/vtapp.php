<?php
    ...
    class MRK_Chiamate_in_attesa_customf6b6052121f52d1f3eeb9bc0dc2f1374 extends vtApp {
...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
 ...
 $group=array();
  $k=0;
  $fld=explode(",","Project_Project_Name,Project_Substatus,Project_RMA,Project_LBLGROUPBUYER,Project_Account,Project_Start_Date,Project_Tipo_Incident,Project_Tipo_Incident_esteso,Project_ID_mail_Merkur");
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $fld=explode(",","Project_Project_Name,Project_Substatus,Project_RMA,Project_LBLGROUPBUYER,Project_Account,Project_Start_Date,Project_Tipo_Incident,Project_Tipo_Incident_esteso,Project_ID_mail_Merkur,vis");
                                  $fldn=explode(",","Nome Progetto,Substatus,RMA,Committente,Azienda/Cliente,Data d'inizio,Tipo incident,Tipo Incident esteso,ID mail Merkur,Visualizza");
                                          $fldnex=explode(","," ,Nome Progetto,Substatus,RMA,Committente,Azienda/Cliente,Data d'inizio,Tipo incident,Tipo Incident esteso,ID mail Merkur,Visualizza");
                                        $colex=explode(","," ,Nome Progetto,Substatus,RMA,Committente,Azienda/Cliente,Data d'inizio,Tipo incident,Tipo Incident esteso,ID mail Merkur ,Visualizza");
 ...
 $l=0;
 $m=0;
 $fp = fopen('MRK_Chiamate_in_attesa_customf6b6052121f52d1f3eeb9bc0dc2f1374.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvMRK_Chiamate_in_attesa_customf6b6052121f52d1f3eeb9bc0dc2f1374'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIMRK_Chiamate_in_attesa_customf6b6052121f52d1f3eeb9bc0dc2f1374.tpl");
        }
