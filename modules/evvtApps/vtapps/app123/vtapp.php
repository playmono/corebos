<?php
    ...
    class Pivot_Tempi_medi_CAT_customb111d84d0077d6236cf3d97a0082afb4 extends vtApp {
...
$fp = fopen('Tempi_medi_CAT_customb111d84d0077d6236cf3d97a0082afb4.csv', 'w');
    fputcsv($fp, $fldnex,";");
    fclose($fp);
 $l=0;
 $m=0;
 echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvPivot_Tempi_medi_CAT_customb111d84d0077d6236cf3d97a0082afb4'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUITempi_medi_CAT_customb111d84d0077d6236cf3d97a0082afb4.tpl");
        }
