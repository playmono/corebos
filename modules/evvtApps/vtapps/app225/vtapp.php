<?php
    ...
    class KPI_Chiamate_custome263c4d6b2a4eb4543eedaa7ffd2794e extends vtApp {
...
$group2=implode(",",$group);
                $qr=strtolower("select $fields 1 as primid FROM ".$rq[1]." group by $group2");
}
  else{
        $qr=strtolower($rq[0]." ,1 as primid FROM ".$rq[1]);}
            }
            if(""!="") $lim="Limit 0,";
        else $lim="";
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $fldn=explode(",","id,data,Mese-anno,commessa,committente,numero chiamate,check21,medialtp,checkltp,adjcheckltp,medialtr,checkltr,adjcheckltr,medialtrhr,checkltrhr,adjcheckltrhr,Visualizza");
                                        ...
                                        $colex=explode(","," ,Mese-anno,commessa,committente,numero chiamate,check21,medialtp,checkltp,adjcheckltp,medialtr,checkltr,adjcheckltr ,Visualizza");
 ...
 $l=0;
 $m=0;
 $fp = fopen('KPI_Chiamate_custome263c4d6b2a4eb4543eedaa7ffd2794e.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvKPI_Chiamate_custome263c4d6b2a4eb4543eedaa7ffd2794e'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIKPI_Chiamate_custome263c4d6b2a4eb4543eedaa7ffd2794e.tpl");
        }
