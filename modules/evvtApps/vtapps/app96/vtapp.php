<?php
    ...
    class Call_21_giorni_per_committente_custombbbcbeceb94740eb249584704eceb3c7 extends vtApp {
...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
    ...
    $grp=explode(",",",,,,1,,,,,,,,,,,,,,");
    $suba=explode(",",",,,count,,,count,,,,,,,,,,,,");

 $group=array();
  $k=0;
  $fld=explode(",","Project_Progetto_collegato,Project_Project_Name,Project_Project_No,Project_ID,Project_LBLGROUPBUYER,Project_Substatus,Project_RMA,Project_ID_progetto,Project_Assigned_To,Project_Macro_status,Project_Account,Project_Data_di_Acquisto_del_Prodotto,Project_Start_Date,Project_Serial_Number,Project_Modified_Time,Project_Model_Number,Project_Id_product,Project_Brand,Project_Status");
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $fld=explode(",","Project_Progetto_collegato,Project_Project_Name,Project_Project_No,Project_ID,Project_LBLGROUPBUYER,Project_Substatus,Project_RMA,Project_ID_progetto,Project_Assigned_To,Project_Macro_status,Project_Account,Project_Data_di_Acquisto_del_Prodotto,Project_Start_Date,Project_Serial_Number,Project_Modified_Time,Project_Model_Number,Project_Id_product,Project_Brand,Project_Status,vis");
                                  $fldn=explode(",","Project_Progetto_collegato,Project_Project_Name,Project_Project_No,N. chiamate aperte,Nome CAT,Substatus,N. chiamate aperte,Project_ID_progetto,Project_Assigned_To,Project_Macro_status,Project_Account,Project_Data_di_Acquisto_del_Prodotto,Project_Start_Date,Project_Serial_Number,Project_Modified_Time,Project_Model_Number,Project_Id_product,Project_Brand,Project_Status,Visualizza");
                                  $checkf=explode(",",",,,,1,,1,,,,,,,,,,,,,1");
                                  $grp=explode(",",",,,,,,,,,,,,,,,,,,,");
                                  $aggr=explode(",",",,,count,,,count,,,,,,,,,,,,,");
                                 $suba=explode(",",",,,count,,,count,,,,,,,,,,,,,");
                                        $wdth=explode(",","200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,150");
                                     $f=Array();
                                     $s=Array();
                                     $a=Array();
                                    $g=Array();
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUICall_21_giorni_per_committente_custombbbcbeceb94740eb249584704eceb3c7.tpl");
        }
