<?php
    ...
    class Scorecard_custom2710a7f894e0ea184197596e9bfb408c extends vtApp {
...
$group2=implode(",",$group);
                $qr=strtolower("select $fields vtiger_payment.paymentid as primid FROM ".$rq[1]." group by $group2");
}
        else{
        $qr=strtolower($rq[0]." ,vtiger_payment.paymentid as primid FROM ".$rq[1]);}
            }
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $fldn=explode(",","Periodo,Payment_Created_Time,Payment_related_account,Payment_Assigned_To,Data Pubblicazione,Data Scadenza,Payment_Conferma_Lettura,Payment_KPI_1,Payment_KPI_2,Payment_KPI_3,Payment_KPI_4,Payment_KPI_5,Payment_KPI_6,Payment_KPI_7,Payment_KPI_8,Payment_KPI_9,Payment_KPI_10,Payment_KPI_11,Payment_KPI_12,Payment_KPI_13,Payment_KPI_14,Payment_KPI_15,Payment_KPI_16,Payment_KPI_17,Payment_KPI_18,Payment_KPI_19,Payment_KPI_20,Visualizza");
                                  $checkf=explode(",","1,,,,1,1,,,,,,,,,,,,,,,,,,,,,,1");
                                  $grp=explode(",",",,,,,,,,,,,,,,,,,,,,,,,,,,,");
                                  $aggr=explode(",",",,,,,,,,,,,,,,,,,,,,,,,,,,,");
                                 $suba=explode(",",",,,,,,,,,,,,,,,,,,,,,,,,,,,");
                                        $wdth=explode(",","200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,200,150");
                                     $f=Array();
                                     $s=Array();
                                     $a=Array();
                                    $g=Array();
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIScorecard_custom2710a7f894e0ea184197596e9bfb408c.tpl");
        }
