<?php
    ...
    class Overdue_CAT_custom32382ab9d528b04b258572eae7c32617 extends vtApp {
...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
 ...
 $group=array();
  $k=0;
  $fld=explode(",","Project_Project_Name,Project_LBLGROUPBUYER,Project_RMA,Project_Start_Date,Project_Substatus,Project_Stato_parte_chiamata,Project_Differenza,Messages_Message");
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $fld=explode(",","Project_Project_Name,Project_LBLGROUPBUYER,Project_RMA,Project_Start_Date,Project_Substatus,Project_Stato_parte_chiamata,Project_Differenza,Messages_Message,vis");
                                  $fldn=explode(",","Chiamata,Cat,RMA,Data di inizio,Substatus,Stato parte,Over,Messaggio,Visualizza");
                                          $fldnex=explode(","," ,Chiamata,Cat,RMA,Data di inizio,Substatus,Stato parte,Over,Messaggio,Visualizza");
                                        $colex=explode(","," ,Chiamata,Cat,RMA,Data di inizio,Substatus,Stato parte,Over,Messaggio ,Visualizza");
                                 ...
                                 $suba=explode(",","count,,,,,,,,");
                                        ...
                                        $wdth=explode(",","120,200,120,120,200,120,40,300,150");
                                     $f=Array();
                                     $s=Array();
                                     $a=Array();
                                    $g=Array();
 ...
 $l=0;
 $m=0;
 $fp = fopen('Overdue_CAT_custom32382ab9d528b04b258572eae7c32617.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvOverdue_CAT_custom32382ab9d528b04b258572eae7c32617'\">";
...
if($name!='messagesmessage') $fals='false';
else $fals='true';
 $c[$k]="$name: { editable: $fals, nullable: true $type}";
}}
$d=0;
...
$f=implode(",",$f).",";
$c=implode(",",$c).",";
$fieldcolumns="[$f { command: [\"edit\"], title:\"&nbsp;\" , width: \"80px\"}]";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIOverdue_CAT_custom32382ab9d528b04b258572eae7c32617.tpl");
        }
