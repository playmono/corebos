<?php
    ...
    class Chiamata_TPV--Open_custom361c4ff06c40f1a032c0d5b31add3346 extends vtApp {
...
global $adb,$current_language,$current_user;
 ...
 $l=0;
 $m=0;
 $fp = fopen('Chiamata_TPV--Open_custom361c4ff06c40f1a032c0d5b31add3346.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvChiamata_TPV--Open_custom361c4ff06c40f1a032c0d5b31add3346'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIChiamata_TPV--Open_custom361c4ff06c40f1a032c0d5b31add3346.tpl");
        }
