<?php
    ...
    class Pivot_Tempi_medi_CAT_custom7ffc8d0e6fe36fc8dd0f86727e7caf84 extends vtApp {
...
$fp = fopen('Tempi_medi_CAT_custom7ffc8d0e6fe36fc8dd0f86727e7caf84.csv', 'w');
    fputcsv($fp, $fldnex,";");
    fclose($fp);
 $l=0;
 $m=0;
 echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvPivot_Tempi_medi_CAT_custom7ffc8d0e6fe36fc8dd0f86727e7caf84'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUITempi_medi_CAT_custom7ffc8d0e6fe36fc8dd0f86727e7caf84.tpl");
        }
