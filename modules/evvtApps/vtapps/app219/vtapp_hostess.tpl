...
{ //alert('index.php?module=evvtApps&action=evvtAppsAjax&file=kendo_content&kaction=add_new&type=edit&module_related='+document.getElementById('module_selected').value+'&module_selected={/literal}{$MODULE_RELATED}{literal}'+'&related_id={/literal}{$id}{literal}');
 $.post('index.php?module=evvtApps&action=evvtAppsAjax&file=kendo_content&kaction=add_new&module_related='+mod+'&module_selected='+mod_rel+'&related_id='+id+'&index='+index,
...
{ //alert('index.php?module=evvtApps&action=evvtAppsAjax&file=kendo_content&kaction=add_new&type=edit&module_related='+document.getElementById('module_selected').value+'&module_selected={/literal}{$MODULE_RELATED}{literal}'+'&related_id={/literal}{$id}{literal}');
 $.post('index.php?module=evvtApps&action=evvtAppsAjax&file=kendo_content&kaction=add_new&type=edit&module_selected=Documents&id=&index='+index+'&module_related='+mod+'&related_id='+id,
...
{ //alert('index.php?module=evvtApps&action=evvtAppsAjax&file=kendo_content&kaction=add_new&type=edit&module_related='+document.getElementById('module_selected').value+'&module_selected={/literal}{$MODULE_RELATED}{literal}'+'&related_id={/literal}{$id}{literal}');
 $.post('index.php?module=evvtApps&action=evvtAppsAjax&file=kendo_content&kaction=add_new&type=edit&module_related='+mod_rel+'&module_selected='+mod+'&id='+id+'&index='+index,
          {onsave_secondary:'{/literal}{$onsave_secondary}{literal}',
           onsave_primary:'{/literal}{$onsave_primary}{literal}',
           add_document:'{/literal}{$add_document}{literal}',
           edit_this:'{/literal}{$edit_this}{literal}',
