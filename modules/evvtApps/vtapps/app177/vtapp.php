<?php
    ...
    class Closed_SONY_customb2a36b8950427268a204afa3b01abc82 extends vtApp {
...
global $adb,$current_language,$current_user;
 ...
 $l=0;
 $m=0;
 $fp = fopen('Closed_SONY_customb2a36b8950427268a204afa3b01abc82.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvClosed_SONY_customb2a36b8950427268a204afa3b01abc82'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIClosed_SONY_customb2a36b8950427268a204afa3b01abc82.tpl");
        }
