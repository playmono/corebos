<?php
    ...
    class Call_TPV_globale_customf17a160bfb41e7b6d73357cc2f5e8569 extends vtApp {
...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
 ...
 $group=array();
  $k=0;
  $fld=explode(",","Project_Progetto_collegato,Project_Substatus,Project_RMA,Project_ID_progetto,Project_LBLGROUPBUYER,Project_Project_No,Project_Account,Project_Created_Time,Project_Status,Project_Actual_End_Date");
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $fld=explode(",","Project_Progetto_collegato,Project_Substatus,Project_RMA,Project_ID_progetto,Project_LBLGROUPBUYER,Project_Project_No,Project_Account,Project_Created_Time,Project_Status,Project_Actual_End_Date,vis");
                                  $fldn=explode(",","Commessa,Substatus,Project_RMA,Project_ID_progetto,Committente,N.,Project_Account,Project_Created_Time,Project_Status,Project_Actual_End_Date,Visualizza");
                                  $checkf=explode(",","1,1,,,1,1,,,,,1");
                                  $grp=explode(",",",,,,,,,,,,");
                                  $aggr=explode(",",",,,,,count,,,,,");
                                 $suba=explode(",",",,,,,count,,,,,");
                                        $wdth=explode(",","120,200,200,200,120,200,200,200,200,200,150");
                                     $f=Array();
                                     $s=Array();
                                     $a=Array();
                                    $g=Array();
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUICall_TPV_globale_customf17a160bfb41e7b6d73357cc2f5e8569.tpl");
        }
