<?php
    ...
    class Chiamate_TPV--Open_custom95a069dca62c0245c9ff1aae4d184473 extends vtApp {
...
global $adb,$current_language,$current_user;
 ...
 $l=0;
 $m=0;
 $fp = fopen('Chiamate_TPV--Open_custom95a069dca62c0245c9ff1aae4d184473.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvChiamate_TPV--Open_custom95a069dca62c0245c9ff1aae4d184473'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIChiamate_TPV--Open_custom95a069dca62c0245c9ff1aae4d184473.tpl");
        }
