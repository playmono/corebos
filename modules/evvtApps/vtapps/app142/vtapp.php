<?php
    ...
    class CIN_SCORE_custom560e3ee2d5e978dd3a6001bec0741899 extends vtApp {
...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
 ...
 $group=array();
  $k=0;
  $fld=explode(",","CAT,SOGLIE,soglieid,Tengagementcliente,Tricezioneprodotto,Tpartrequest,TsentbyTek,Tconfirmreceiv,Trepairing,Treadytodeliver");
...
$group2=implode(",",$group);
        ...
        $qr=strtolower($rq[0]." ,.id as primid FROM ".$rq[1]);}
              ...
              $query1="show columns from mv_soglia";
...
$fl=implode(",",$fl);
                $rq=explode("from","select $fl from mv_soglia ");
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $fld=explode(",","CAT,SOGLIE,soglieid,Tengagementcliente,Tricezioneprodotto,Tpartrequest,TsentbyTek,Tconfirmreceiv,Trepairing,Treadytodeliver,vis");
                                  $fldn=explode(",","CAT,SOGLIE,soglieid,Wait prod,Predia,Part request,TsentbyTek,Confirm,Repairing,Ready,Visualizza");
                                          $fldnex=explode(","," ,CAT,SOGLIE,soglieid,Wait prod,Predia,Part request,TsentbyTek,Confirm,Repairing,Ready,Visualizza");
                                        $colex=explode(","," ,CAT,SOGLIE,Wait prod,Predia,Part request,Confirm,Repairing,Ready ,Visualizza");
                                 ...
                                 $suba=explode(",",",,,,,,,,,,");
                                        ...
                                        $wdth=explode(",","200,120,200,80,80,80,200,80,80,80,150");
                                     $f=Array();
                                     $s=Array();
                                     $a=Array();
                                    $g=Array();
 ...
 $l=0;
 $m=0;
 $fp = fopen('CIN_SCORE_custom560e3ee2d5e978dd3a6001bec0741899.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvCIN_SCORE_custom560e3ee2d5e978dd3a6001bec0741899'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUICIN_SCORE_custom560e3ee2d5e978dd3a6001bec0741899.tpl");
        }
