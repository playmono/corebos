...
class vtApp {
	...
	public function getContent($lang) {		
	    if($_REQUEST['action']==='editvtapp') 
            return file_get_contents("modules/evvtApps/vtapps/app$this->appid/content.php");
            elseif($_REQUEST['action']==='evvtAppsAjax')
            include("modules/evvtApps/vtapps/app$this->appid/content.php");
	}
 public function setContent($content){                     
                file_put_contents("modules/evvtApps/vtapps/app$this->appid/content.php", $content);   
        }
