<?php
    ...
    class Chiamata_TPV--Open_customc1e95c1baec06a2a5c998561865a6491 extends vtApp {
...
global $adb,$current_language,$current_user;
 ...
 $l=0;
 $m=0;
 $fp = fopen('Chiamata_TPV--Open_customc1e95c1baec06a2a5c998561865a6491.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvChiamata_TPV--Open_customc1e95c1baec06a2a5c998561865a6491'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIChiamata_TPV--Open_customc1e95c1baec06a2a5c998561865a6491.tpl");
        }
