<?php
    ...
    class Commesse_da_HR_a_PUR_custom1136f2b481b083a24633501a1fd41507 extends vtApp {
...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
 ...
 $group=array();
  $k=0;
  $fld=explode(",","Project_RMA,Project_Project_Name,Project_LBLGROUPBUYER,Project_Start_Date,Project_Serial_Number,Project_Substatus,Project_Account,Project_ID_progetto,Project_Assigned_To,PCDetails_Nome_richiesta_parte,PCDetails_Stato_Parte");
...
global $adb,$current_language,$current_user;
		...
		$smarty->template_dir = $this->apppath;
                                  ...
                                  $fld=explode(",","Project_RMA,Project_Project_Name,Project_LBLGROUPBUYER,Project_Start_Date,Project_Serial_Number,Project_Substatus,Project_Account,Project_ID_progetto,Project_Assigned_To,PCDetails_Nome_richiesta_parte,PCDetails_Stato_Parte,vis");
                                  $fldn=explode(",","RMA,Descrizione Progetto,Commitente,Data di inizio,Serial Number,Substatus,Responsabile,ID progetto,Project_Assigned_To,Nome richiesta parte,Stato Parte,Visualizza");
                                          $fldnex=explode(","," ,RMA,Descrizione Progetto,Commitente,Data di inizio,Serial Number,Substatus,Responsabile,ID progetto,Project_Assigned_To,Nome richiesta parte,Stato Parte,Visualizza");
                                        $colex=explode(","," ,RMA,Descrizione Progetto,Commitente,Data di inizio,Serial Number,Substatus,Responsabile,ID progetto,Nome richiesta parte,Stato Parte ,Visualizza");
                                 ...
                                 $suba=explode(",",",,,,,,,,,,,");
                                        ...
                                        $wdth=explode(",","80,100,100,80,80,80,100,80,100,100,80,150");
                                     $f=Array();
                                     $s=Array();
                                     $a=Array();
                                    $g=Array();
 ...
 $l=0;
 $m=0;
 $fp = fopen('Commesse_da_HR_a_PUR_custom1136f2b481b083a24633501a1fd41507.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvCommesse_da_HR_a_PUR_custom1136f2b481b083a24633501a1fd41507'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUICommesse_da_HR_a_PUR_custom1136f2b481b083a24633501a1fd41507.tpl");
        }
