<?php
    ...
    class Pivot_Call_21_giorni_custom9f48cc0d9196996959f77a78f56a265a extends vtApp {
...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
 ...
 $group=array();
  $k=0;
  $fld=explode(",","Project_ID,Project_LBLGROUPBUYER,Project_Progetto_collegato,Project_Project_Name,Project_Project_No,Project_Substatus,Project_RMA,Project_ID_progetto,Project_Assigned_To,Project_Macro_status,Project_Account,Project_Data_di_Acquisto_del_Prodotto,Project_Start_Date,Project_Serial_Number,Project_Modified_Time,Project_Model_Number,Project_Id_product,Project_Brand,Project_Status");
...
if(""!="1"){
                                  $fld=explode(",","vtiger_project.linktobuyer_vtiger_project.progetto,$cat2 $form $form2 $tot");
                                  $fldn=explode(",","Committente_Commessa,ubstatus $cat $form1 $form12 $tot");
          ...
          $fld=explode(",","vtiger_project.linktobuyer_vtiger_project.progetto,$cat2 $ytd $form $form2 $tot");
                                  $fldn=explode(",","Committente_Commessa,ubstatus $cat $ytd1 $form1 $form12 $tot");
                                  $checkf=explode(",",",1,1,,,,,,,,,,,,,,,,,1");
                                  $grp=explode(",",",,");
                                  $aggr=explode(",",",,,");
                                 $suba=explode(",",",,");
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUICall_21_giorni_custom9f48cc0d9196996959f77a78f56a265a.tpl");
        }
