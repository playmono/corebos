<?php
    ...
    class OnGoing_SONY_custom2d2105cc5209897223020fc492ae8a7f extends vtApp {
...
global $adb,$current_language,$current_user;
 ...
 $l=0;
 $m=0;
 $fp = fopen('OnGoing_SONY_custom2d2105cc5209897223020fc492ae8a7f.csv', 'w');
    fputcsv($fp, $colex,";");
    fclose($fp);
  echo "<input type=\"button\" value=\"Export csv\" onclick=\"window.location.href='index.php?module=evvtApps&action=exportcsvOnGoing_SONY_custom2d2105cc5209897223020fc492ae8a7f'\">";
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUIOnGoing_SONY_custom2d2105cc5209897223020fc492ae8a7f.tpl");
        }
