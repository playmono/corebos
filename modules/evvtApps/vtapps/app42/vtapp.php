<?php
    ...
    class Pivot_TT_day_by_custom01dbfbe468b296519833e4ef92edfe9d extends vtApp {
...
if(""!="1"){
                                  $fld=explode(",","vtiger_crmentityHelpDesk.createdtime,$cat2, $form Totale");
                                  $fldn=explode(",","Creazione,Status $cat,$form Totale");
                                  $checkf=explode(",",",,,,,1,,,,,,,,1");
                                  $grp=explode(",",",,");
                                  $aggr=explode(",",",,,");
                                 $suba=explode(",",",,");
          ...
          $fld=explode(",","vtiger_crmentityHelpDesk.createdtime,$cat2,ytd,$form Totale");
                                  $fldn=explode(",","Creazione,Status $cat,Year to date, $form Totale");
                                  $checkf=explode(",",",,,,,1,,,,,,,,1");
                                  $grp=explode(",",",,");
                                  $aggr=explode(",",",,,");
                                 $suba=explode(",",",,");
...
$smarty->assign("cond1",$condit);
                	return $smarty->display("ListViewKUITT_day_by_custom01dbfbe468b296519833e4ef92edfe9d.tpl");
        }
