...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
 ...
 $group=array();
  $k=0;
  $fld=explode(",","projectid,projecttaskid,projectname,projecttaskname,timecontrolid,status_timecontrol,deleted,date_start,time_start,progetto,substatus,case_tc");
