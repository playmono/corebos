...
$reportquery=$focus1->sGetSQLforReport($reportid,$nu);
 ...
 $group=array();
  $k=0;
  $fld=explode(",","Project_ID,Project_Progetto_collegato,Project_Project_Name,Project_Project_No,Project_RMA,Project_LBLGROUPBUYER,Project_Substatus,Project_ID_progetto,Project_Assigned_To,Project_Macro_status,Project_Account,Project_Data_di_Acquisto_del_Prodotto,Project_Start_Date,Project_Serial_Number,Project_Modified_Time,Project_Model_Number,Project_Id_product,Project_Brand,Project_Status");
