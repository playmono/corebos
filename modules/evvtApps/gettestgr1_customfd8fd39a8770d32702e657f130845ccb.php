...
global $adb;
$fp = fopen('testgr1_customfd8fd39a8770d32702e657f130845ccb.csv', 'a');
...
$checkf=explode(",","1,1,1,1,1,1,1,1");
 ...
 $group=array();
  $k=0;
  $fld=explode(",","Project_Project_Name,Project_Project_No,Project_Stato_Reso_Servizio,Project_Tariffa_Reso_Servizio,Project_Riconoscimento_Reso_Servizio,Project_Ripetitiva,Project_LBLGROUPBUYER");
