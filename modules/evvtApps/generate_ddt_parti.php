...
WHERE projectid =$inoutmaster";
    ...
    $focus->column_fields['adocmastername']='OUTGOING DDT PARTE';
...
//$nr_doc = $nr_doc;
   ...
   $query=$adb->pquery("Select cityname from vtiger_cities
    ...
    $focus->column_fields['project']=$inoutmaster; 
     $focus->column_fields['causaleadm']='OUTGOING DDT PARTE';    
   ...
   // $focus->column_fields['nrdoc']=$nr_doc; 
    ...
    $focus_det->id='';
    if(strpos($adb->query_result($result,$i,'pcdetailsstatus'),"ANNULLATO")!=false || strpos($adb->query_result($result,$i,'pcdetailsstatus'),"ANNULLATA")!=false ) 
            continue;
...
//                     WHERE tipo_documento='OUTGOING DDT PARTE'   ";
//        
