<?php
    ...
    $tit="(Giorno per Numero HelpDesk_ID)";
...
$dt=Array();
       ...
       $rspots1=$adb->query("SELECT  count(vtiger_crmentity.crmid)  as vtigercrmentitycrmid  FROM $query  and  REPLACE(CONCAT(vtiger_troubletickets.opendatatext),\"'\",\"\")='$ptc' and vtiger_troubletickets.status=\"$cat[$m]\" ");
