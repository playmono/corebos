...
<table border=0 cellspacing=0 cellpadding=5 width=95% align=center> 
	<tr>
		<td class=small >
			...
			<input type="checkbox" name="sttime_check" <?php if($current_user->start_hour != ''){?> checked <?php } ?> onClick="enableCalstarttime();">&nbsp;<?php echo $c_mod_strings['LBL_CALSTART']?> 
			<select name="start_hour" <?php if($current_user->start_hour == ''){?>disabled <?php } ?> class="small">
				<?php
					for($i=0;$i<=23;$i++)
					{
						if($i == 0)
            ...
            <tr>
                <td align="left">
        			<input type="checkbox" name="hour_format" <?php if($current_user->hour_format == '24'){?> checked <?php } ?> value="24">&nbsp;<?php echo $c_mod_strings['LBL_USE24']?>
        	    </td>
            </tr>
            <tr>
                <td align="left">
        			<input type="checkbox" name="show_weekends" <?php if($Calendar_Settings["show_weekends"] == 'true'){?> checked <?php } ?> value="1">&nbsp;<?php echo $mod_strings['LBL_SHOW_WEEKENDS']?>
        	    </td>
            </tr>
            <tr>
                <td align="left">
     ...
     multiple style="height:70px;width:100%">
                                                            ...
                                                            <td width=20% align=center valign=top>
                                                                    <input type=button value="<?php echo $c_mod_strings['LBL_ADD_BUTTON'] ?> >>" class="crm button small save" style="width:100%" onClick="incUser('available_users','selected_users')"><br>
